            ...
            <div className="max-w-8xl mx-auto px-4 md:px-20 py-10 z-10 relative">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex gap-2 mb-4">
                        ...
                        alt="MasterCard"
                        className="w-12 sm:w-5 md:w-8 lg:w-10 xl:w-20 h-auto  transition-transform duration-200 hover:scale-105"
                        />
                    ))}
                    </div>
                    {/* Hàng dưới: 3 ảnh */}
                    ...
                    {Array(3).fill(0).map((_, idx) => (
                        ...
                        src="https://vudigital.co/wp-content/uploads/2022/12/logo-mastercard-da-thay-doi-nhu-the-nao-trong-hon-50-nam-2.webp"
                        alt="MasterCard"
                        className="w-12 sm:w-5 md:w-8 lg:w-10 xl:w-20 transition-transform duration-200 hover:scale-105"
                        />
                    ))}
                    </div>
                </div>
